...
@section('title', __('ticket.admin.edit.title'))
@section('content')
<div class="col-md-12">
  <div class="col-md-10">
      <div class="tile">
        <h3 class="tile-title">@lang('ticket.admin.edit.title')</h3>
        ...
        @endif
        <div class="tile-body">
          <form class="form-horizontal" action="{{ route('admin.tickets.update', $ticket->id) }}" method="post">
            @csrf
            @method('PUT')
            <div class="form-group row">
              <label class="control-label col-md-3">@lang('ticket.admin.table.schedule_id')</label>
              <div class="col-md-8" >
                <select name="schedule_id" id="schedule_id" class="form-control col-md-12" disabled>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <input class="form-control" type="text" name="type" value="{{$ticket->type}}" placeholder="{{__('ticket.admin.add.placeholder_type')}}">
              </div>
            </div>
            <div class="form-group row">
              <label class="control-label col-md-3">@lang('ticket.admin.table.price')</label>
              <div class="col-md-8">
                <input class="form-control" type="number" name="price" value="{{$ticket->price}}" placeholder="{{__('ticket.admin.add.placeholder_price')}}">
              </div>
            </div>
            <div class="row">
              <div class="col-md-8 col-md-offset-3">
                <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>
                  @lang('ticket.admin.add.edit')
                </button>
                &nbsp;&nbsp;&nbsp;
