  ...
  <ul class="app-nav">
     ...
     <li class="dropdown">
        ...
        <ul class="dropdown-menu settings-menu dropdown-menu-right">
           <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="fa fa-cog fa-lg"></i>{{ __('master.setting') }}</a></li>
           <li><a class="dropdown-item" href="{{ route('admin.dashboard') }}"><i class="fa fa-user fa-lg"></i>
            @if (Auth::user())
              {{ Auth::user()->full_name }}
           @endif
          </a></li>
